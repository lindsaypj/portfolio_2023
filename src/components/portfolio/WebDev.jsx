  ...
  return (
    <Row className='bg-gradient-down pb-10' ref={scrollRef}>
      <Col className='p-0'>
        ...
        {/* Advise It */}
        <Row className='portfolio__row padding-margins d-block d-xl-flex'>
          <Col className='py-4 px-0 col-12 col-xl-4 d-flex align-items-end align-items-xl-center order-1 order-xl-2 align-items-center'>
            <div>
              <h3>
                Advise IT
        ...
        <Row className='portfolio__row padding-margins d-flex'>
          ...
          <Col className='p-0 py-xl-4 ps-xl-5 col-12 col-xl-8 d-flex align-items-center order-2 order-xl-1'>
            <PortfolioCarousel
              desktopImages={[
                {
