export default function DartLogo({ className = '' }) {
  return (
    <a href='https://dart.dev/' target='_blank' rel='noreferrer' title='Dart'>
      <svg className={className} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" width="443px" height="138.46px" viewBox="0 0 443 138.46" enableBackground="new 0 0 443 138.46">
        <g>
